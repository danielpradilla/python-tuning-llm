...
class ScriptArguments:
    train_dataset_path: str = field(
        default=None,
        metadata={
            "help": "Path to the training dataset, should be /opt/ml/input/data/train_dataset.json"
        },
    )
    eval_dataset_path: str = field(
        default=None,
        metadata={
            "help": "Path to the eval dataset, should be /opt/ml/input/data/eval_dataset.json"
        },
    )
    model_id: str = field(
    ...
    dataset_text_field: str = field(default='text', metadata={"help": "The name of the text field of the dataset"},
    )
...
if __name__ == "__main__":
    ...
    # Conditionally load the validation dataset if the path is provided
    eval_dataset = None
